...
/**
 * AnimateLifecycle transitions between mount / unmount of its child components.
 * 
 * Props:
 ...
 *	</TransitionLifecycle>
 */
export default function AnimateLifecycle({ children, transition, willRender, verbose }: AnimateMountProps): JSX.Element {
